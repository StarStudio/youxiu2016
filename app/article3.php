...
<?php
require 'conn.php';
  $sql="select id,title from article3 ORDER BY ordernum";
...
<li role="prenstation" class="active"><a href="article3.php">奔跑</a></li>
...
$i=1;
  ...
  {
		echo " <li class='list-group-item'><span scope='row'>$i</span>&nbsp;&nbsp;&nbsp;<a   href='../article3.php?id=$row[id]'><h4 style='display:inline;' >$row[title]</h4></a></li><a style='padding-left: 400px;' type='button' href='edit3.php?id=$row[id]'>编辑</a></br>"; 
		$i++;
 }
       
 ?>
  <a type='button' class='btn btn-default' href='order.php?table=article3' >顺序修改</a>
</ul>
  </br>
  </br>
<div class="panel panel-default col-xs-offset-2 col-xs-8">
<div class="panel-heading">发表</div>
<form class="form-horizontal col-xs-9" enctype="multipart/form-data" name="input" action="artsub3.php" method="post">
