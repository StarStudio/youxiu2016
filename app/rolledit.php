...
<div class="form-group">
	...
	<div><input type="hidden" class="form-control" value="roll" name="table"></div>
</form>
</div>
...
$(document).ready(function(){
	...
	var yes = "<a type='button' class='btn btn-default' href='delete.php?id=<?php echo $id; ?>&table=roll&choice=y'>确认</a>"; 
	var no = "<a type='button' class='btn btn-default' href='delete.php?id=<?php echo $id; ?>&table=roll&choice=n'>取消</a>";
	$(document).ready(function(){
