...
$id=$_GET['id'];
include 'conn.php';
  $sql="select * from article1 where id=$id";
...
<div class="form-group">
	...
	<div><input type="hidden" class="form-control" value="article1" name="table"></div>
</form>
</div>
...
$(document).ready(function(){
	...
	var yes = "<a type='button' class='btn btn-default' href='delete.php?id=<?php echo $id; ?>&table=article1&choice=y'>确认</a>"; 
	var no = "<a type='button' class='btn btn-default' href='delete.php?id=<?php echo $id; ?>&table=article1&choice=n'>取消</a>";
	$(document).ready(function(){
