...
session_start();
include 'conn.php';
  $sql="select id,title,ordernum from article1 ORDER BY ordernum";
...
<li role="prenstation" class="active"><a href="article1.php">青春</a></li>
...
$i=1;
  ...
  {
		echo " <li class='list-group-item'><span scope='row'>$i</span>&nbsp;&nbsp;&nbsp;<a   href='../article1.php?id=$row[id]'><h4 style='display:inline;' >$row[title]</h4></a></li><a style='padding-left: 400px;' type='button' href='edit1.php?id=$row[id]'>编辑</a></br>"; 
  $i++;
  }
       
 ?>
 <a type='button' class='btn btn-default' href='order.php?table=article1' >顺序修改</a>
</ul>
</br>
...
<form class="form-horizontal col-xs-9" enctype="multipart/form-data" name="input" action="artsub1.php" method="post">
